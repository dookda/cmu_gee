...
![This is an image](/cmu_gee/docs/img/regis.png)
หน้าต่างให้ลงทะเบียนเพื่อขอให้งาน
![This is an image](/cmu_gee/docs/img/regis2.png)
...
```
ผลการทำงาน
![This is an image](./cmu_gee/img/false_composite.png)
...
```
ผลการทำงาน
![This is an image](./cmu_gee/img/output.png)
